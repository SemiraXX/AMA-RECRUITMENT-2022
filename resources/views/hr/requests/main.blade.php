    ...
    <div class="row">
        <div class="col-sm-8">
            <p class="hr-dashboard-title">Requests</p><br>
        </div>
        <div class="col-sm-4">
    ...
    <div class="hrtabbtnwrapper" style="border-bottom:solid 1px white; padding-bottom:15px">
        ...
        <a href="#"><button id="btnshortlist" type="button" class="manage-application-tab-btn">Non ACAD</button></a>
        <a href="#"><button id="btnshortlist" type="button" class="manage-application-tab-btn">ACAD</button></a>
    </div>
