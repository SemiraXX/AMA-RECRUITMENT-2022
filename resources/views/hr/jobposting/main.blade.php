    ...
    <div class="row">
        <div class="col-sm-8">
            <p class="hr-dashboard-title">Job Posting</p><br>
        </div>
        <div class="col-sm-4">
    ...
    <div class="hrtabbtnwrapper" style="border-bottom:solid 1px white; padding-bottom:15px">
        <a href="/HR/job/posting"><button id="btnhrdashboard" type="button" class="manage-application-tab-btn">For posting</button></a>
        <a href="#"><button id="btnshortlist" type="button" class="manage-application-tab-btn">Active Jobs</button></a>
        <a href="#"><button id="btnshortlist" type="button" class="manage-application-tab-btn">Closed Jobs</button></a>
    </div>
